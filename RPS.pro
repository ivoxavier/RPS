...
UBUNTU_TRANSLATION_DOMAIN="rps.ivoxavier"
...
aptest.commands = bash $$PWD/RPS/tests/autopilot/run
aptest.depends  = sub-RPS

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/RPS/tests/unit 
unittest.depends  = sub-RPS
